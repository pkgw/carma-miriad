	...
	real lstart,lwidth,lstep,vobs,epoch,sumlumv,sumuuvv
	...
	integer Count,naver,nchan,mcount
     ...
     *	  lstart,lwidth,lstep,epoch,vobs,sumlumv,sumuuvv,
     *	  Count,naver,nchan,mcount,doinit,mfs,mosaic,
