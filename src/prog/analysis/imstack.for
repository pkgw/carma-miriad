c***********************************************************************
      ...
      implicit none
c
c= imstack - stack images with optional filtering
c& pjt
c: map combination
c+
c	IMSTACK is a MIRIAD task which combines several images into
...
c------------------------------------------------------------------------
      ...
      include 'mem.h'
      character version*(*)
      parameter(version='ImComb: version 1.0 25-feb-2011')
      integer MAXIN,MAXOPEN
      parameter(MAXIN=500,MAXOPEN=6)
c
      character in(MAXIN)*128,tin*128,out*128
