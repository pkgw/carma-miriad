...
c= tac - dynamic scheduling program.
c& mchw
c: misc
c+
c	TAC is a scheduling program to sort a prioritized list into
...
c	then TAC advances the LST and schedules the next project.
c@ phfile
...
c	TAC keeps track of the integration time
