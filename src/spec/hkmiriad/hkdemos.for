...
c
	...
	real rms
	double precision x0,y0,xin(3),xout(3)
	double precision crpix1,crval1,crpix2,crval2
	character line*64
c
c  Header keywords.
c
...
c
     ...
     *	                        'crval3  ','crval4  ','crval5  ',
     *	  'ctype1  ','ctype2  ','ctype3  ','ctype4  ','ctype5  ',
     *	  'epoch   ','history ','niters  ','object  ',
...
c
	...
	call wrhdd(tOut,'obsra', crval1)
	call wrhdd(tOut,'obsdec',crval2)
c
	do i=1,nkeys
	  call hdcopy(tMap,tOut,keyw(i))
	enddo
	call wrhda(tOut,'telescop',pbtype)
