...
echo "Performance tests for ATA multichannel imaging"
...
rm -r $config.$dec.uv
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec harange=$harange source=$MIRCAT/point.source telescop=hatcreek systemp=40 jyperk=150 freq=$freq corr=$nchan,1,1,100 out=$config.$dec.uv
# pnoise=30
...
echo " " >> timing
echo " Config  DEC  Nchan HA[hrs]  Rms[mJy]  Beam[arcsec] Tb_rms[mK] Sidelobe[%]:Rms,Max,Min Nvis[%]" >> timing
