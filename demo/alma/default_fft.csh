...
rm -r $config.$dec.cas.$cell.mem.fft_default7
fft rin=$config.$dec.cas.$cell.mem mag=$config.$dec.cas.$cell.mem.fft_default7
ellint in=$config.$dec.cas.$cell.mem.fft_default7 log=$config.$dec.cas.$cell.mem.fft_default7.ellint options=natural scale=10

rm -r $config.$dec.cas.$cell.resid.fft_default7
fft rin=$config.$dec.cas.$cell.resid mag=$config.$dec.cas.$cell.resid.fft_default7
set scale = `imlist options=stat in=$config.$dec.cas.$cell.resid | grep Effective | awk '{print 10/$4}'`
ellint in=$config.$dec.cas.$cell.resid.fft_default7 log=$config.$dec.cas.$cell.resid.fft_default7.ellint options=natural scale=$scale
