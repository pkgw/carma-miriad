...
#  22apr10 mchw. hex1-23.csh. merge hex, default and joint scripts.
...
# scale modee size. eg. cell=0.1 arcsec -> 80" diameter 
...
echo "   ---  Mosaicing with CARMA-23  -  $0 model=$model,  `date`   " > timing
...
# CARMA
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec lat=37.02 harange=$harange source=$MIRCAT/no.source systemp=80,290,0.26 jyperk=73 freq=$freq corr=$nchan,1,0,$bw out=carma.uv telescop=carma ellim=$ellim 

# OVRO
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec lat=37.02 harange=$harange source=$MIRCAT/no.source systemp=80,290,0.26 jyperk=43  freq=$freq corr=$nchan,1,0,$bw out=ovro.uv telescop=ovro ellim=$ellim 

# HATCREEK
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec lat=37.02 harange=$harange source=$MIRCAT/no.source systemp=80,290,0.26 jyperk=126 freq=$freq corr=$nchan,1,0,$bw out=hatcreek.uv telescop=hatcreek ellim=$ellim 

# SZA
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec lat=37.02 harange=$harange source=$MIRCAT/no.source systemp=80,290,0.26 jyperk=383 freq=$freq corr=$nchan,1,0,$bw out=sza.uv telescop=sza ellim=$ellim 

# SZA-OVRO
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec lat=37.02 harange=$harange source=$MIRCAT/no.source systemp=80,290,0.26 jyperk=128 freq=$freq corr=$nchan,1,0,$bw out=sza10.uv telescop=sza10 ellim=$ellim 

# SZA-BIMA
uvgen ant=$config.ant baseunit=-3.33564 radec=23:23:25.803,$dec lat=37.02 harange=$harange source=$MIRCAT/no.source systemp=80,290,0.26 jyperk=220 freq=$freq corr=$nchan,1,0,$bw out=sza6.uv telescop=sza6 ellim=$ellim 
...
implot in=$config.$dec.$model.$cell.mp device=/xs units=s region=quart
